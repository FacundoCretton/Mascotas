...
export const productsSpecifications = {
    ...
    1: {
        ...
        beneficios: [
          'Pulpa de remolacha: Excelente fuente de fibras. Ayuda a regular la actividad intestinal y la flora digestiva, beneficiosa para el organismo de tu perro.',
    ...
    2: {
        ...
        beneficios: [
          'Extracto de Yucca: Ayuda a formar una capa protectora en las paredes intestinales impidiendo que sufran daños. Regula las fermentaciones intestinales favoreciendo la producción de ácidos grasos beneficiosos y evitando la producción de amoniaco.',
